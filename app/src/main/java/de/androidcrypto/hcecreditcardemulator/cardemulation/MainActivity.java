...
import de.androidcrypto.hcecreditcardemulator.R;
import de.androidcrypto.hcecreditcardemulator.common.activities.SampleActivityBase;
...
public class MainActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogShown = true; // todo show menu, here it is fixed to true
